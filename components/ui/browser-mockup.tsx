...
const sizeClasses: Record<NonNullable<BrowserMockupProps["size"]>, string> = {
  default:
    "aspect-[16/10] min-h-[140px] max-h-[min(38vh,260px)] sm:min-h-[220px] sm:max-h-[min(44vh,300px)] lg:min-h-[240px] lg:max-h-none",
  large:
    "aspect-[16/10] min-h-[140px] max-h-[min(40vh,280px)] sm:min-h-[240px] sm:max-h-[min(48vh,340px)] lg:min-h-[400px] lg:max-h-none",
  hero:
    "aspect-[16/10] min-h-[140px] max-h-[min(42vh,300px)] sm:min-h-[260px] sm:max-h-[min(50vh,360px)] lg:min-h-[420px] xl:min-h-[460px] lg:max-h-none",
  heroCompact:
    "aspect-[16/9] w-full min-h-[130px] max-h-[min(36vh,240px)] sm:min-h-[150px] sm:max-h-[min(46vh,300px)] lg:max-h-[360px]",
  xl:
    "aspect-[16/10] min-h-[150px] max-h-[min(42vh,300px)] sm:min-h-[300px] sm:max-h-[min(50vh,360px)] lg:min-h-[460px] xl:min-h-[520px] lg:max-h-none",
  showcase:
